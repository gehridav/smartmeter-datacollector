...
from gurux_dlms.objects import GXDLMSClock, GXDLMSData, GXDLMSMBusClient, GXDLMSRegister
...
DEFAULT_REGISTER_MAPPING = [
    ...
    RegisterCosem(OBISCode(1, 1, 1, 7, 0), MeterDataPointTypes.ACTIVE_POWER_P.value),
    RegisterCosem(OBISCode(1, 0, 2, 7, 0), MeterDataPointTypes.ACTIVE_POWER_N.value),
    RegisterCosem(OBISCode(1, 1, 2, 7, 0), MeterDataPointTypes.ACTIVE_POWER_N.value),
   
    RegisterCosem(OBISCode(1, 0, 3, 7, 0), MeterDataPointTypes.REACTIVE_POWER_P.value),
    RegisterCosem(OBISCode(1, 1, 3, 7, 0), MeterDataPointTypes.REACTIVE_POWER_P.value),    
    RegisterCosem(OBISCode(1, 0, 4, 7, 0), MeterDataPointTypes.REACTIVE_POWER_N.value),
    RegisterCosem(OBISCode(1, 1, 4, 7, 0), MeterDataPointTypes.REACTIVE_POWER_N.value),
...
class Cosem:
    ...
    def retrieve_external_id(self, dlms_objects: Dict[OBISCode, Any]) -> str:
        id_obis = self._find_obis_of_id(dlms_objects)
        if not id_obis:
